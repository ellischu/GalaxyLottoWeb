<%@ Page Language="C#" Title="Cacul01" AutoEventWireup="true" EnableSessionState="True" CodeBehind="Cacul01.aspx.cs" Inherits="GalaxyLottoWeb.Pages.Cacul01" %>
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
                <asp:Panel ID="pnlinfo" runat="server" Width="100%" ScrollBars="Auto" Direction="LeftToRight" HorizontalAlign="Center" BackColor="Black" ForeColor="White">
                    ...
                    <asp:DropDownList ID="ddlOption" runat="server" BackColor="Black" ForeColor="White" AutoPostBack="true" OnSelectedIndexChanged="DdlOptionSelectedIndexChanged">
                        <asp:ListItem Text="頻率組1" Value="FreqSet01" Selected="True" />
                        <asp:ListItem Text="頻率組2" Value="FreqSet02" />
                        <asp:ListItem Text="前期" Value="PreDate" />
                    </asp:DropDownList>
                </asp:Panel>
                ...
                <asp:Panel ID="pnlTopData" runat="server" ScrollBars="Auto" ForeColor="White" BackColor="Black" Visible="false">
                    ...
                    <br />
                    <asp:Label runat="server" ID="lblMethod" Font-Size="Small" />
                    <br />
                    <asp:Label runat="server" ID="lblSearchMethod" Font-Size="Small" />
                </asp:Panel>
                <%--搜尋結果--%>
