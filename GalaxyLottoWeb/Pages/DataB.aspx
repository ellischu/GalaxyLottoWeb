<%@ Page Language="C#" Title="DataB" Async="true" AutoEventWireup="true" EnableSessionState="True" CodeBehind="DataB.aspx.cs" Inherits="GalaxyLottoWeb.Pages.DataB" %>
...
<head runat="server">
    ...
    <link href="DataB.ico" rel="shortcut icon" type="image/x-icon" />
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            ...
            <ContentTemplate>
                <asp:Panel ID="pnlinfo" runat="server" CssClass="pnlinfo" HorizontalAlign="Center">
                    ...
                    <asp:Button ID="btnT1Start" runat="server" Text="T1更新中" Visible="true" OnClick="BtnT1StartClick" Font-Size="Smaller" ForeColor="LightGreen" BackColor="Black" BorderColor="Black" BorderWidth="0" />
                    <br />
                    ...
                    <asp:DropDownList ID="ddlFreq" runat="server" CssClass="gldropdownlist" />
                    <asp:DropDownList ID="ddlNums" runat="server" CssClass="gldropdownlist" />
                    <asp:DropDownList ID="ddlDays" runat="server" CssClass="gldropdownlist" Visible="false">
                    ...
                    <asp:DropDownList ID="ddlPercent" runat="server" CssClass="gldropdownlist" Visible="false">
                    ...
                    <asp:DropDownList ID="ddlDisplay" runat="server" CssClass="gldropdownlist" Visible="false">
