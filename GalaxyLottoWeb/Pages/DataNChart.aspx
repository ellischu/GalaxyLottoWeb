<%@ Page Language="C#" Title="DataN" Async="true" AutoEventWireup="true" EnableSessionState="True" CodeBehind="DataNChart.aspx.cs" Inherits="GalaxyLottoWeb.Pages.DataNChart" %>
            ...
            <ContentTemplate>
                <asp:Panel ID="pnlinfo" runat="server" CssClass="pnlinfo" HorizontalAlign="Center">
                    ...
                    <asp:DropDownList ID="ddlFuntion" runat="server" CssClass="gldropdownlist" AutoPostBack="true">
                        <asp:ListItem Text="振盪圖表" Value="DataNChart" Selected="True" />
                    </asp:DropDownList>
