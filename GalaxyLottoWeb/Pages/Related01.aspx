<%@ Page Title="Related" Language="C#" MasterPageFile="~/MasterPages/Site.Master" EnableViewState="true" EnableSessionState="True" AutoEventWireup="true" CodeBehind="Related.aspx.cs" Inherits="GalaxyLottoWeb.Pages.Relatetion" %>
        ...
        <ContentTemplate>
            <asp:Panel ID="Panel1" runat="server" CssClass="glcontainer" HorizontalAlign="Center">
                ...
                <asp:Panel ID="Panel5" runat="server">
                    <asp:Calendar ID="Calendar01" runat="server" OnSelectionChanged="Calendar01_SelectionChanged" OnDayRender="Calendar01_DayRender" FirstDayOfWeek="Monday">
                ...
                <asp:Label ID="lblDate" runat="server" CssClass="gllabel" Text="No dates selected." />
            </asp:Panel>
        </ContentTemplate>
    </asp:UpdatePanel>
</asp:Content>
