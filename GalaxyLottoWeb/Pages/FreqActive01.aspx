<%@ Page Language="C#" Title="FreqActive01" AutoEventWireup="true" EnableSessionState="True" CodeBehind="FreqActive01.aspx.cs" Inherits="GalaxyLottoWeb.Pages.FreqActive01" %>
...
<body id="body" class="glbody">
    ...
    <form runat="server">
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            ...
            <ContentTemplate>
                <asp:Panel ID="pnlinfo" runat="server" CssClass="pnlinfo" HorizontalAlign="Center" ScrollBars="Auto">
                ...
                <asp:Panel ID="pnlDetail" runat="server">
                    ...
                    <asp:Label runat="server" ID="lblBriefDate" CssClass="NotDisplay" Font-Size="X-Large" />
