<%@ Page Language="C#" Title="FreqDNAT" AutoEventWireup="true" EnableSessionState="True" CodeBehind="FreqDNAT.aspx.cs" Inherits="GalaxyLottoWeb.Pages.FreqDnaT" %>
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            ...
            <ContentTemplate>
                ...
                <asp:Panel ID="pnlSum" runat="server" CssClass="glColumn750" Visible="false">
                    <asp:Label ID="lblSum" runat="server" Text="數字DNA" CssClass="gllabel" />
                    <asp:GridView ID="gvSum" runat="server" AutoGenerateColumns="false" CssClass="gltable" GridLines="Horizontal" />
                </asp:Panel>
                <asp:Panel ID="pnlFreqDNA01" runat="server" CssClass="glColumn750" Visible="false">
