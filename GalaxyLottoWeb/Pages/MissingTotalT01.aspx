<%@ Page Language="C#" Title="MissingTotalT01" AutoEventWireup="true" EnableSessionState="True" CodeBehind="MissingTotalT01.aspx.cs" Inherits="GalaxyLottoWeb.Pages.MissingTotalT01" %>
    ...
    <form id="formMissingTotalT" runat="server" class="glresult">
        ...
        <asp:UpdatePanel ID="UPnlMissTotalT" runat="server">
            ...
            <ContentTemplate>
                ...
                <%--<asp:Panel ID="Panel1" runat="server" CssClass="glColumn750" ScrollBars="None" />--%>
            </ContentTemplate>
        </asp:UpdatePanel>
    </form>
</body>
