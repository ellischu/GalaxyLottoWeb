<%@ Page Language="C#" Title="FreqDNA" AutoEventWireup="true" EnableSessionState="True" CodeBehind="FreqDNA.aspx.cs" Inherits="GalaxyLottoWeb.Pages.FreqDna" %>
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            ...
            <ContentTemplate>
                ...
                <asp:Panel ID="pnlDetail" runat="server" CssClass="glColumn750" EnableViewState="false" ViewStateMode="Disabled">
                    <asp:Label ID="lblFreqDNA01" runat="server" Text="數字DNA出現率" CssClass="gllabel" />
                    <asp:GridView ID="gvFreqDNA01" runat="server" AutoGenerateColumns="false" CssClass="gltable" GridLines="Horizontal" />

                    <details id="dtlFreqDNA" runat="server" visible="false" style="background-color: lightyellow">
                        <asp:Label ID="lblFreqDNA" runat="server" Text="數字DNA" CssClass="gllabel" />
                        <asp:GridView ID="gvFreqDNA" runat="server" AutoGenerateColumns="false" CssClass="gltable" GridLines="Horizontal" />
                    </details>
