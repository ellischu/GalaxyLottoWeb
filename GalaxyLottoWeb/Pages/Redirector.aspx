<%@ Page Language="C#" Title="Redirector" AutoEventWireup="true" EnableSessionState="True" CodeBehind="Redirector.aspx.cs" Inherits="GalaxyLottoWeb.Pages.Redirector" %>
...
<body class="glbody">
    ...
    <form runat="server">
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
                <asp:Label runat="server" ID="lblWait" Text="載入中,請稍候(Wait) ...." BackColor="Red" ForeColor="Yellow" />
            </ContentTemplate>
        </asp:UpdatePanel>
    </form>
</body>
